...
@Api(value = "公用动作", description = "记录一切行为流水--max")
@Controller
public class ActionController {
  ...
  public @ResponseBody ResUserCollectRecordBean postUCR(
      @ApiParam(required = true, value = "收藏录播视频入参对象") @RequestBody ReqUserCollectRecordBean reqUserCollectRecordBean) {
  ...
  public @ResponseBody ResUCRCancelBean postUCRCancel(
      @ApiParam(required = true, value = "取消收藏录播视频入参对象") @RequestBody ReqUCRCancelBean reqUCRCancelBean) {
  ...
  public @ResponseBody ResUserPlayRecordBean postUPR(
      @ApiParam(required = true, value = "播放录播视频入参对象") @RequestBody ReqUserPlayRecordBean reqUserPlayRecordBean) {
  ...
  public @ResponseBody ResUserLikeRecordBean postULR(
      @ApiParam(required = true, value = "点赞录播视频入参对象") @RequestBody ReqUserLikeRecordBean reqUserLikeRecordBean) {
  ...
  public @ResponseBody ResULRCancelBean postULRCancel(
      @ApiParam(required = true, value = "取消点赞录播视频入参对象") @RequestBody ReqULRCancelBean reqULRCancelBean) {
  ...
  public @ResponseBody ResUserCollectArticleBean postUCA(
      @ApiParam(required = true, value = "收藏文章入参对象") @RequestBody ReqUserCollectArticleBean reqUserCollectArticleBean) {
    return iActionBiz.postUCA(reqUserCollectArticleBean);
  }

  // 用户取消收藏文章
  @PostMapping("/user/collect/article/cancel")
  @ApiResponses(value = {@ApiResponse(code = 405, message = "invalid input")})
  @ApiOperation(notes = "用户取消对文章收藏", httpMethod = "POST", value = "用户取消收藏文章（OK）")
  public @ResponseBody ResUCACancelBean postUCACancel(
      @ApiParam(required = true, value = "取消收藏文章入参对象") @RequestBody ReqUCACancelBean reqUCACancelBean) {
    return iActionBiz.postUCACancel(reqUCACancelBean);
  }
  ...
  public @ResponseBody ResUserReadArticleBean postURA(
      @ApiParam(required = true, value = "阅读文章入参对象") @RequestBody ReqUserReadArticleBean reqUserReadArticleBean) {
