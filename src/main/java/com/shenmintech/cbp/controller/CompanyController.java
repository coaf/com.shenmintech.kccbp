...
@Controller
@Api(value = "公司", description = "公司的相关操作--max")
public class CompanyController {
  ...
  @ApiOperation(notes = "导师创建一个新的公司，公司名字不能重复", httpMethod = "POST", value = "添加新的公司（OK）")
  public @ResponseBody Res4PostCompanyBean postTKcCompany(
      @ApiParam(required = true, value = "添加公司") @RequestBody Req4PostCompanyBean req4PostCompanyBean) {
    return iCompanyBiz.addCompany(req4PostCompanyBean);
  }

  @PostMapping("/tkcCompany/put")
  @ApiResponses(value = {@ApiResponse(code = 405, message = "invalid input")})
  @ApiOperation(notes = "导师更新一个公司的名字/预计人数", httpMethod = "POST", value = "更新公司信息（OK）")
  public @ResponseBody Res4PutComBean putTKcCompany(
      @ApiParam(required = true, value = "更新公司") @RequestBody Req4PutComBean req4PutComBean) {
    return iCompanyBiz.updateCompany(req4PutComBean);
  }

  @PostMapping("/tkcCompany/get")
  @ApiResponses(value = {@ApiResponse(code = 405, message = "invalid input")})
  @ApiOperation(notes = "导师查询所有已添加的共享公司列表", httpMethod = "POST", value = "查询公司信息（OK）")
  public @ResponseBody Res4GetComBean getTKcCompany(
      @ApiParam(required = true, value = "查询对象") @RequestBody Req4GetComBean Req4GetComBean) {
  ...
  public @ResponseBody Res4GetSingleComBean getSingleCompany(
      @ApiParam(required = true, value = "查询对象") @RequestBody Req4GetSingleComBean Req4GetSingleComBean) {
