...
@Controller
@Api(value = "小组", description = "小组的相关操作(包含小组对象和小组实例的操作)--max")
public class GroupController {
  ...
  public @ResponseBody Res4PostGroupBean postTKcGroup(
      @ApiParam(required = true, value = "添加新的小组") @RequestBody Req4PostGroupBean req4PostGroupBean) {
  ...
  public @ResponseBody Res4PutGroupBean putTKcGroup(
      @ApiParam(required = true, value = "更新的小组") @RequestBody Req4PutGroupBean req4PutGroupBean) {
  ...
  public @ResponseBody Res4GetGroupBean getTKcGroup(
      @ApiParam(required = true, value = "查询小组列表对象") @RequestBody Req4GetGroupBean req4GetGroupBean) {
