...
@Controller
@Api(value = "录播课程", description = "录播课程的相关操作--max")
public class RecordController {
  ...
  public @ResponseBody Res4GetRecordsBean getTKcRecords(
      @ApiParam(required = true, value = "查询录播视频列表入参对象") @RequestBody Req4GetRecordsBean req4GetRecordsBean) {
  ...
  public @ResponseBody Res4DeleteRecordBean deleteTKcRecord(
      @ApiParam(required = true, value = "删除某个录播视频入参对象") @RequestBody Req4DeleteRecordBean req4DeleteRecordBean) {
  ...
  public @ResponseBody Res4PostRecordBean postTKcRecord(
      @ApiParam(required = true, value = "添加录播视频入参对象") @RequestBody Req4PostRecordBean req4PostRecordBean) {
  ...
  public @ResponseBody Res4PutRecordStatusBean putTKcRecordStatus(
      @ApiParam(required = true, value = "添加录播视频入参对象") @RequestBody Req4PutRecordStatusBean req4PutRecordStatusBean) {
  ...
  public @ResponseBody Res4PutRecordBean putTKcRecord(
      @ApiParam(required = true, value = "更改录播视频入参对象") @RequestBody Req4PutRecordBean req4PutRecordBean) {
  ...
  public @ResponseBody Res4PatchIndexBean patchTKcRecordIndex(
      @ApiParam(required = true, value = "更改录播视频入参对象") @RequestBody Req4PatchIndexBean req4PatchIndexBean) {
  ...
  public @ResponseBody ResRecords4AppBean getTKcRecords4App(
      @ApiParam(required = true, value = "查询前五个录播视频入参对象") @RequestBody ReqRecords4AppBean req4Records4AppBean) {
  ...
  public @ResponseBody ResRecordsByType4AppBean getRecordsByType(
      @ApiParam(required = true, value = "查看某类型的更多录播视频入参对象") @RequestBody ReqRecordsByType4AppBean reqRecordsByType4AppBean) {
    return iRecordBiz.getRecordsByType4App(reqRecordsByType4AppBean);
  }

  @PostMapping("/tkcRecord4App/get")
  @ApiResponses(value = {@ApiResponse(code = 405, message = "invalid input")})
  @ApiOperation(notes = "用户查询具体某个录播课程", httpMethod = "POST", value = "录播视频详细信息查询（OK）")
  public @ResponseBody ResRecord4AppBean getTKcRecord4App(
      @ApiParam(required = true, value = "查询单个录播视频入参对象") @RequestBody ReqRecord4AppBean req4Records4AppBean) {
    return iRecordBiz.getRecord4App(req4Records4AppBean);
  }

  @PostMapping("user/collect/records/get")
  @ApiResponses(value = {@ApiResponse(code = 405, message = "invalid input")})
  @ApiOperation(notes = "用户查询自己收藏的录播课程", httpMethod = "POST", value = "收藏的录播视频列表查询（OK）")
  public @ResponseBody Res4GetUCRBean getUCR(
      @ApiParam(required = true, value = "查询收藏的录播视频入参对象") @RequestBody Req4GetUCRBean req4GetUCRBean) {
    return iRecordBiz.getUCR(req4GetUCRBean);
  }
