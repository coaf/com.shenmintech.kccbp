...
@Api(value = "用户登录等相关", description = "登录api--max")
@Controller
public class AuthController {
  ...
  public @ResponseBody Res4GetTeacherBean login(
      @ApiParam(required = true, value = "用户登录信息") @RequestBody Req4GetTeacherBean req4GetTeacherBean) {
