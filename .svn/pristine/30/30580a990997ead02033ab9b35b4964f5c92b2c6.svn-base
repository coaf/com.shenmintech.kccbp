...
public class TKcHomeworkSignCard {
  private String id;
  ...
  public void setBreakfastFlag(Integer breakfastFlag) {
    this.breakfastFlag = breakfastFlag;
  }

  public Integer getLunchFlag() {
    return lunchFlag;
  }

  public void setLunchFlag(Integer lunchFlag) {
    this.lunchFlag = lunchFlag;
  }

  public Integer getSupperFlag() {
    return supperFlag;
  }

  public void setSupperFlag(Integer supperFlag) {
