...
@Controller
@Api(value = "推送", description = "推送（课后作业）相关操作--max")
public class HomeworkPushController {
  ...
  public @ResponseBody Res4GetPrePushHomeworkBean preHomework(
      @ApiParam(required = true, value = "前置对象") @RequestBody Req4GetPrePushHomeworkBean req4GetPrePushHomeworkBean) {
  ...
  public @ResponseBody Res4PostPushHomeworkBean postHomework(
      @ApiParam(required = true, value = "添加推送任务对象") @RequestBody Req4PostPushHomeworkBean req4PostPushHomeworkBean) {
  ...
  public @ResponseBody Res4GetPushHomeworksBean getHomeworks(
      @ApiParam(required = true, value = "查询推送任务列表") @RequestBody Req4GetPushHomeworksBean req4GetPushHomeworksBean) {
  ...
  public @ResponseBody Res4PutPushHomeworkBean putHomework(
      @ApiParam(required = true, value = "更新推送任务入参对象") @RequestBody Req4PutPushHomeworkBean req4PutPushHomeworkBean) {
